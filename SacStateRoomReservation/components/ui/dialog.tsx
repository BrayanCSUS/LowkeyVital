...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="fixed right-6 top-6 rounded-full bg-[#00563F] text-white opacity-100 shadow-lg hover:bg-[#C4B581] hover:text-[#00563F] focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 transition-all w-10 h-10 flex items-center justify-center z-[100]">
        <X className="h-7 w-7" />
